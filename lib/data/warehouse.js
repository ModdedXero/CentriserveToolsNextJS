    ...
    for (let i = 0; i < locations.length; i++) {
        for (let j = 0; j < locations[i].categories.length; j++) {
            if (locations[i].categories[j].name === oldCat.name) {
                locations[i].categories[j].name = newCat.name;
                locations[i].categories[j].unique = newCat.unique;
                locations[i].categories[j].itemNames = newCat.itemNames;
                locations[i].categories[j].customFields = newCat.customFields;
            }
        }
    }
